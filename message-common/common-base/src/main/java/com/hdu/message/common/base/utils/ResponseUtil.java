 ...
 * </ul>
 * <li> 6xx，小商城后端业务错误码，
 * 具体见huiermall-admin-api模块的AdminResponseCode。
 * <li> 7xx，管理后台后端业务错误码，
 * 具体见huiermall-wx-api模块的WxResponseCode。
 * </ul>
 */
public class ResponseUtil {
    ...
    public static Object normal(String code, String res,Object data) {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", code);
        obj.put("errmsg", res);
        obj.put("data",data);
    ...
    public static Object fail( String errmsg,Exception e) {
        Map<String, Object> obj = new HashMap<String, Object>(3);
        obj.put("errno", -1 );
        obj.put("errmsg", errmsg);
        obj.put("errInfo", ExceptionUtil.getExceptionToString(e));
        return obj;
    }
